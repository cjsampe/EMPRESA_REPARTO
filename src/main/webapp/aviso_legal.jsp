...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="images/logo_pestaÃ±acda.png"> 
    ...
    <body>
        <header>
            <nav class="menu-navegacion contenedor">
                ...
                <div class="enlaces">
                    ...
                    <li><a href="aviso_legal_ingles.jsp" class="boton"><img src="images/bandera_inglesa.jpg" style="width:70%"></a></li>
                    </ul>
                </div>
            </nav>
            <section class="hero">
        ...
        <p>
            ...
            NIF/CIF:2222222G
            <br>
            Domicilio: Gran Vía, 16
            <br>
            Correo electrónico: cdaexpress@paqueteria.com
            <br>
            Sitio Web: www.cdaexpress.com
            
            <br>
            <br>
            <h3>Finalidad</h3>
            La finalidad de www.cdaexpress.com es la 
            página web de la empresa de paquetería CDAexpress.
            <br>
            <br>
            ...
            han publicadon por medio de Internet.
            <br>
            ...
            forma puedan dañar, inutilizar, sobrecargar, deteriorar o impedir 
            la normal utilización de los contenidos, los equipos informáticos o 
            los documentos, archivos y toda clase de contenidos almacenados en 
            cualquier equipo informático propios o contratados por el Titular, 
            ...
            de terceros, o que, a su juicio, no resulten adecuados para su publicación.
            El Titular no será responsable de las opiniones vertidas por los usuarios a 
            través del sistema de comentarios, redes sociales u otras herramientas de 
            participación, conforme a lo previsto en la normativa de aplicación.
            <br>
            <br>
            ...
            el Titular, que asume todas las medidas de índole técnica, organizativa y de 
            ...
            necesarios y toma las medidas de seguridad oportunas para evitar la presencia 
            de estos elementos dañinos.
            ...
            tomado todas las medidas razonables para asegurar que la información contenida 
            es correcta, el Titular no garantiza que sea exacta, completa o actualizada. 
            El Titular declina expresamente cualquier responsabilidad por error u omisión 
            en la información contenida en las páginas de este sitio Web.
            Queda prohibido transmitir o enviar a través del sitio Web cualquier contenido 
            ilegal o ilícito, virus informáticos, o mensajes que, en general, afecten o 
            violen derechos de el Titular o de terceros.
            Los contenidos del Sitio Web tienen únicamente una finalidad informativa y 
            bajo ninguna circunstancia deben usarse ni considerarse como oferta de venta, 
            solicitud de una oferta de compra ni recomendación para realizar cualquier 
            otra operación, salvo que así se indique expresamente.
            </p></div>
            <br>
            <br>
